...
import no.nav.familie.endringsmelding.integration.dto.pdl.Bostedsadresse
import no.nav.familie.endringsmelding.integration.dto.pdl.BostedsadresseBarn
import no.nav.familie.endringsmelding.integration.dto.pdl.DeltBosted
import no.nav.familie.endringsmelding.integration.dto.pdl.Dødsfall
import no.nav.familie.endringsmelding.integration.dto.pdl.Familierelasjonsrolle.BARN
import no.nav.familie.endringsmelding.integration.dto.pdl.Familierelasjonsrolle.FAR
import no.nav.familie.endringsmelding.integration.dto.pdl.ForelderBarnRelasjon
import no.nav.familie.endringsmelding.integration.dto.pdl.Fødsel
import no.nav.familie.endringsmelding.integration.dto.pdl.Matrikkeladresse
import no.nav.familie.endringsmelding.integration.dto.pdl.MatrikkeladresseBarn
import no.nav.familie.endringsmelding.integration.dto.pdl.Navn
import no.nav.familie.endringsmelding.integration.dto.pdl.PdlBarn
import no.nav.familie.endringsmelding.integration.dto.pdl.PdlSøker
import no.nav.familie.endringsmelding.integration.dto.pdl.PdlSøkerData
import no.nav.familie.endringsmelding.integration.dto.pdl.PersonBolk
import no.nav.familie.endringsmelding.integration.dto.pdl.PersonDataBolk
...
import no.nav.familie.endringsmelding.integration.dto.pdl.Statsborgerskap
import no.nav.familie.endringsmelding.integration.dto.pdl.Vegadresse
